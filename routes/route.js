...
router.get("/movie/:id/delete", movieController.movie_get_delete);

router.post("/movie/:id/delete", movieController.movie_post_delete);

//handles updating movies
router.get("/movie/:id/update", movieController.movie_get_update)

router.post("/movie/:id/update", movieController.movie_post_update)
...
router.get("/copy/:id/delete", copyController.copy_get_delete);

router.post("/copy/:id/delete", copyController.copy_post_delete);

//handles updating copies
router.get("/copy/:id/update", copyController.copy_get_update)

router.post("/copy/:id/update", copyController.copy_post_update)
...
router.get("/genre/:id/delete", genreController.genre_get_delete);

router.post("/genre/:id/delete", genreController.genre_post_delete);

//handles updating genres
router.get("/genre/:id/update", genreController.genre_get_update)

router.post("/genre/:id/update", genreController.genre_post_update)
